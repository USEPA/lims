...
namespace SFSB_Slopes_Intercepts_CF
{
    public class SFSB_Slopes_Intercepts_CF : DataProcessor
    {
        public override string id { get => "Sfsb_slopes_intercepts_cf1.0"; }
        public override string name { get => "SFSB_Slopes_Intercepts_CF"; }
        public override string description { get => "Processor used for SFSB_Slopes_Intercepts_CorrectionFactors translation to universal template"; }
        ...
        public override DataTableResponseMessage Execute()
        {
            ...
            try
            {
                ...
                string aliquotF = GetXLStringValue(worksheet.Cells[3, ColumnIndex1.F]);
