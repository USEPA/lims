...
namespace SFSB_Light_Hydrocarbons
{
    public class SFSB_Light_Hydrocarbons : DataProcessor
    {
        public override string id { get => "sfsb_light_hydrocarbons1.0"; }
        public override string name { get => "SFSB_Light_Hydrocarbons"; }
        public override string description { get => "Processor used for SFSB_Light_Hydrocarbons translation to universal template"; }
