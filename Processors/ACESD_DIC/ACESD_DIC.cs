...
namespace ACESD_DIC
{
    public class ACESD_DIC : DataProcessor
    {

        public override string id { get => "acesd_dic_version1.0"; }
        public override string name { get => "ACESD_DIC"; }
        public override string description { get => "Processor used for ACESD DIC translation to universal template"; }
